...
Uso:  python -m src.integrations.presidio.roundtrip_test [model_dir_o_hf_id]
"""
import re
import sys
...
def main():
    ...
    user_text = ("Il Sig. Mario Rossi, C.F. RSSMRA85H12F205Z, chiede il bonifico di "
                 "€ 12.500,00 sull'IBAN IT60X0542811101000000123456 in favore della "
    ...
    assert not PH_RE.search(anon) is None or "Mario Rossi" not in anon, \
        "PII non anonimizzata verso l'LLM!"
    assert "Mario Rossi" not in anon and "RSSMRA85H12F205Z" not in anon, \
